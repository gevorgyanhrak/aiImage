...
const PresetHero = ({ title, description }: IPresetHero) => {
  return (
    <div className="flex flex-col gap-2" data-testid={TEST_IDS.CONTAINER}>
      <h2
        className="text-[22px] md:text-[26px] font-semibold leading-tight tracking-[-0.01em] text-[var(--page-text)] first-letter:uppercase"
      ...
      {description && (
        <p
          className="text-sm leading-relaxed text-[var(--page-text-secondary)] first-letter:uppercase line-clamp-3"
